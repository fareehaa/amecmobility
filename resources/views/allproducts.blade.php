            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 small">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-111.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                                            <span class="icon"><img src="{{asset('front/img/icon-1.png')}}" alt=""></span>
                                                            <span class="text">Learn More</span>
                                                        </span>
                                                    </a>
                                                    <a class="button size-2 style-3" href="#">
                                                        <span class="button-wrapper">
                                                            <span class="icon"><img src="{{asset('front/img/icon-3.png')}}" alt=""></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 small">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-112.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 small">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-113.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 small">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-114.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="product-shortcode style-1 small">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-49.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                    ...
                    <div class="align-inline spacing-1 hidden-xs">
                        <a class="pagination toggle-products-view active"><img src="{{asset('front/img/icon-14.png')}}" alt="" /><img src="{{asset('front/img/icon-15.png')}}" alt="" /></a>
                        <a class="pagination toggle-products-view"><img src="{{asset('front/img/icon-16.png')}}" alt="" /><img src="{{asset('front/img/icon-17.png')}}" alt="" /></a>
                    </div>
                            ...
                            <div class="row nopadding">
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        <div class="title">
                                            ...
                                            <div class="h6 animate-to-green"><a href="/product/1">Smartphone vibe x2</a></div>
                                        </div>
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-40.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-41.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-42.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-43.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-44.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-45.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-46.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-47.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
                                ...
                                <div class="col-sm-4">
                                    <div class="product-shortcode style-1">
                                        ...
                                        <div class="preview">
                                            <img src="{{asset('front/img/product-48.jpg')}}" alt="">
                                            <div class="preview-buttons valign-middle">
                                                <div class="valign-middle-content">
                                                    <a class="button size-2 style-2" href="#">
                                                        <span class="button-wrapper">
