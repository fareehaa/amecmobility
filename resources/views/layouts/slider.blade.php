                    ...
                    <div class="slider-product-preview">
                        <div class="product-preview-shortcode">
                            <div class="preview">
                                ...
                                <div class="entry full-size swiper-lazy active" data-background="{{asset('front/img/product-preview-1.jpg')}}"></div>
                                <div class="entry full-size swiper-lazy" data-background="{{asset('front/img/product-preview-2.jpg')}}"></div>
                                <div class="entry full-size swiper-lazy" data-background="{{asset('front/img/product-preview-3.jpg')}}"></div>
                            </div>
                            <div class="sidebar valign-middle" data-swiper-parallax-x="-300">
                                <div class="valign-middle-content">
                                    <div class="entry active"><img src="{{asset('front/img/product-4.png')}}" alt="" /></div>
                                    <div class="entry"><img src="{{asset('front/img/product-5.png')}}" alt="" /></div>
                                    <div class="entry"><img src="{{asset('front/img/product-6.png')}}" alt="" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
