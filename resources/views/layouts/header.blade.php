        ...
        <div class="content-margins">
            <div class="row">
                <div class="col-md-5 hidden-xs hidden-sm">
                    ...
                    <div class="entry"><b>email:</b> <a href="mailto:office@exzo.com">office@amecmobility.com</a></div>
                </div>
                <div class="col-md-7 col-md-text-right">
                <div class="entry"><a class="open-popup" data-rel="1"><b><a href="{{route('login')}}">Login</a></b></a>&nbsp; or &nbsp;<a class="open-popup" data-rel="2"><b><a href="{{route('register')}}">Register</a></b></a></div>
        ...
        <div class="content-margins">
            <div class="row">
                <div class="col-xs-3 col-sm-1">
                    <a id="logo" href="">amecmobility{{-- <img src="img/logo-2.png" alt="" /> --}}</a>  
                </div>
