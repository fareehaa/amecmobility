        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Whishlist</a></li>
              <li><a href="#timeline" data-toggle="tab">Orders</a></li>
                    ...
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <br>
                          <img class="img-responsive" src="{{asset('admin/dist/img/photo3.jpg')}}" alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
